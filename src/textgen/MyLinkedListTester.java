...
public class MyLinkedListTester {
	...
	public void testAddEnd()
	{
		...
		// test error when adding a null value.
		try {
			shortList.add(null);
		...
		assertEquals("Add element to empty list: check value is correct", (Integer) 1, emptyList.get(0));
		assertEquals("Add element to empty list: check return value is True", true, b);
		assertEquals("Add element to empty list: check size is correctly updated", 1, emptyList.size());
