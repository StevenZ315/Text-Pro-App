...
class WPTreeNode {
	...
	/**
	 * Add a child of a node containing the String s precondition: The word is
	 * not already a child of this node
	 * 
	 * @param s
	 ...
	 * 
	 * @return The list of strings starting at the root and ending at the
	 *         calling object
	 */
